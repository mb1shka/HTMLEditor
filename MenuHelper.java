...
public class MenuHelper {
    ...
    public static JMenuItem addMenuItem(JMenu parent, String text, ActionListener actionListener) {
        ...
        JMenuItem menuItem = new JMenuItem(text); //новый пункт меню
        menuItem.addActionListener(actionListener);
        parent.add(menuItem); //добавляем в меню наш новый пункт
        return menuItem;
    }
    ...
    public static JMenuItem addMenuItem(JMenu parent, Action action) {
        //то же самое, только принимает на вход действие action, которое необходимо выполнить при выборе пункта меню
